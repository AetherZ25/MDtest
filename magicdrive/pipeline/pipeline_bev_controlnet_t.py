            ...
            for i, t in enumerate(timesteps):
                ...
                if double_cfg_inference and do_classifier_free_guidance:
                    ...
                    _down_block_res_samples[1] = [
                        ...
                        down_block_res_samples]
                    _camera_params_raw = [None, None]
                    _camera_params_raw[0] = {k: v.chunk(
                        2)[0] for k, v in camera_params_raw.items()}
                    _camera_params_raw[1] = {k: v.chunk(
                        2)[1] for k, v in camera_params_raw.items()}
                    if hasattr(self.unet, "crossview_attn_type"):
                        additional_param[0]['camera_params_raw'] = _camera_params_raw[0]
                        additional_param[1]['camera_params_raw'] = _camera_params_raw[1]
